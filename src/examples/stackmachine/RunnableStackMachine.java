                             ...
                             implements ComponentListener, WindowListener
{
    ...
    private class PushButton extends ImageButton implements ActionListener
    {
        PushButton()
        {
            super ("img/push_button.gif"
                , "img/push_buttonr.gif"
                , "img/push_buttonp.gif"
            );
            addActionListener(this);
        }
    ...
    private class SubtractButton extends ImageButton implements ActionListener
    {
        SubtractButton()
        {
            super ("img/subtract_button.gif"
                , "img/subtract_buttonr.gif"
                , "img/subtract_buttonp.gif"
            ); 
            addActionListener(this);
        }
    ...
    private class MultiplyButton extends ImageButton implements ActionListener
    {
        MultiplyButton ()
        {
            super ("img/multiply_button.gif"
                , "img/multiply_buttonr.gif"
                , "img/multiply_buttonp.gif"
            );
            addActionListener(this);
        }
    ...
    private class DivideButton extends ImageButton implements ActionListener
    {
        DivideButton()
        {
            super ("img/divide_button.gif"
                , "img/divide_buttonr.gif"
                , "img/divide_buttonp.gif"
            );
            addActionListener(this);
        }
